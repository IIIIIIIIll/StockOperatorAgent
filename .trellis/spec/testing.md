...
- **全量：0F/216P/20S，约 2-4 分钟**（2026-08-02 mcp-intel-cache +
  market-hours-util 后实测，+20 用例：market_time 9 + mcp_intel_cache 11）。
  历史基线 0F/196P/20S（f10-financial-indicator-sections 后）、0F/188P/20S
