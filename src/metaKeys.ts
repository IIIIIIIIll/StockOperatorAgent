...
// name:${ticker} / '600036' 的写读都在这里 const 化/模板化,换键名或换 demo 票只改一处。
// 说明:
...
/** 每股证券名称 meta 键模板(deviceCollect/webCollect 缓存,quoteClient 读写)。 */
export const nameKey = (ticker: string): string => `name:${ticker}`;
